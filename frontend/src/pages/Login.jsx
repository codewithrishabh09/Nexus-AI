...
import { Key, Mail, Share2, ArrowRight, AlertCircle } from 'lucide-react';
        ...
        <div className="min-h-screen w-screen bg-[#0a0010] flex items-center justify-center p-4 relative">
            ...
            <div className="w-full max-w-md bg-[#0f0015] border border-[#2a1040] rounded-2xl p-6 md:p-8 shadow-2xl relative z-10">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-xl font-bold text-white tracking-wide">Welcome to Nexus AI</h2>
                    <p className="text-xs text-purple-400/60 mt-1">Sign in to access your intelligent workspace</p>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-[#2a1040]/50 text-center">
                    <p className="text-xs text-gray-500">
                        New to Nexus AI?{' '}
                        <button onClick={() => onNavigate('/register')} className="text-pink-400 hover:text-pink-300 font-semibold cursor-pointer">
                            Create Account
                        </button>
                    </p>
                </div>
